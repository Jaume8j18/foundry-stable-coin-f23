...
*
* It is similar to DAI if DAI had no govvernance, no fees, and was only backed by WETH and WBTC
*
...
*
* @notice This contract is the core of the DSC System. It handles all the logic for mining and redeeming DSC, as well
* as depositing and withdrawind collateral
...
contract DSCEngine is ReentrancyGuard {
    ...
    constructor(
        ...
        //ForExample ETH/USD, BTC/USD, MAITC/USD,...
    ...
    * @notice this functiuon will deposit your collateral and mint DSC in one transaction
    */
    ...
    */
    ...
    function redeemCollateralForDsc(
        ...
        external 
        {
            ...
            //redeeemCollateral already checks healthfactor and drops an error
        }

    //in order to redeem collateral:
    // 1. the health factor must be over 1 AFTER collaterals pulled
    //DRY: Dont Repeat yourself
    // CEI: Chcek, Effects, Interactions
    ...
    /*
    *@notice follows CEI
    *@param amountDscToMint The amount of decentralized stalbecoin to mint
    *@notice they have most collateral value than the minimum treshold
    */
    ...
    * @notice You will get a liquidation bonus for taking the users founds
    ...
    * Follows CEI: Checks, Effects, Interactions
    ...
    nonReentrant
    {
        ...
        //Sow we are giving the liquidator 110 of ETH for 100DSC
        //We should implement a feature to liquidate in the event the protocl is insolvent
    ...
    */
    ...
    function _getAccountCollateralValue(address user) public view returns(uint256 totalCollateralValueInUsd){
        //loop through each collatgeral token, get the amount they have deposited, and map it
    ...
    function getHealhtFactor(address user) external view returns (uint256){
